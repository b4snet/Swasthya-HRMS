...
const SENSITIVE_KEYS = new Set([
  ...
  "otp",
  "answer",
  // Phase 2 (ADR-010 plan §7): SENSITIVE_PERSONAL employee fields must
  // never appear in audit before/after unmasked. Services additionally pass
  // already-masked values; this set is the second line of defense.
  "dateofbirth",
  "date_of_birth",
  "dob",
  "addressline1",
