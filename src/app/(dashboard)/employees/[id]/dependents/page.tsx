...
import { DependentsClient } from "./dependents-client";

export const metadata: Metadata = { title: "Dependents" };

export default async function DependentsPage({ params }: { params: Promise<{ id: string }> }) {
